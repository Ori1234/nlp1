	...
	public static void main(String[] args) {
		...
		for (String lang : langs) {
			...
			for (int n = 2; n < 5; n++) {
				...
				for (double lmbd = 0; lmbd <= 1; lmbd += 1.0 / 20) {
					...
					OptionalDouble aver_proplex = Eval.main(a2);
					res_for_lmbd.put(lmbd, aver_proplex.getAsDouble());
				}
		...
		for (String lang : langs) {
			...
			for (int n = 2; n < 5; n++) {
				...
				System.out.println("****eval test");
				OptionalDouble aver_proplex = Eval.main(a2);
				map.put(n, aver_proplex.getAsDouble());
			}
